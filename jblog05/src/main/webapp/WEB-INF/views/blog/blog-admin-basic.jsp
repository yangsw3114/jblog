				...
				<form action="${pageContext.request.contextPath }/${authUser.getId() }/admin/update" method="post" enctype="multipart/form-data">
	 		      	<table class="admin-config">
			      		...
			      		<tr>
			      			...
			      			<td><input type="text" size="40" name="title" value="${blogbyId.title } "></td>
			      		</tr>
			      		<tr>
			      			<td class="t">로고이미지</td>
			      			<td><img src="${pageContext.request.contextPath }${blogbyId.logo }"></td>
			      			<td><input type="hidden" name="logo" value="${blogbyId.logo }" /></td>
